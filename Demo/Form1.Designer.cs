namespace Demo
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			this.scintilla3.ScrollWidth = 5001;
			this.scintilla3.Size = new System.Drawing.Size(701, 218);
			this.scintilla3.TabIndex = 1;
			this.scintilla3.Text = resources.GetString("scintilla3.Text");
			this.scintilla3.WrapMode = ScintillaNET.WrapMode.Word;
			this.scintilla3.Enter += new System.EventHandler(this.genericScintilla1_Enter);
			this.scintilla3.KeyDown += new System.Windows.Forms.KeyEventHandler(this.genericScintilla_KeyDown);
			// 
